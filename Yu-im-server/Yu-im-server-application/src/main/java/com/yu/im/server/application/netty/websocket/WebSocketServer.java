package com.yu.im.server.application.netty.websocket;
...
import com.yu.im.server.application.netty.websocket.codec.WebSocketMessageProtocolDecoder;
import com.yu.im.server.application.netty.websocket.codec.WebSocketMessageProtocolEncoder;
...
/**
 * @author yu
 * @description 基于 WebSocket 实现的 Netty 服务启动类
 * @date 2024-05-17
 */
@Component
